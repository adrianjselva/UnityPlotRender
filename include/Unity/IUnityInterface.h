#ifndef UNITYPLOTRENDER_IUNITYINTERFACE_H
#define UNITYPLOTRENDER_IUNITYINTERFACE_H
...
//
// UNITY_REGISTER_INTERFACE_GUID should be placed in the header file of any interface definition outside all namespaces.
...
struct UnityInterfaceGUID
{
    ...
    UnityInterfaceGUID& operator=(const UnityInterfaceGUID& other) = default;

    [[nodiscard]] bool Equals(const UnityInterfaceGUID& other)   const { return m_GUIDHigh == other.m_GUIDHigh && m_GUIDLow == other.m_GUIDLow; }
    [[nodiscard]] bool LessThan(const UnityInterfaceGUID& other) const { return m_GUIDHigh < other.m_GUIDHigh || (m_GUIDHigh == other.m_GUIDHigh && m_GUIDLow < other.m_GUIDLow); }
#endif
...
#endif //UNITYPLOTRENDER_IUNITYINTERFACE_H
